...
const logoFiles = {
  ...
  instagram: 'Inst.png',
  kari: 'Kari.png',
  louisVuitton: 'Louis Vuitton.png',
  ...
  porsche: 'Porshe.png',
  reddit: 'reddit.png',
  rollsRoyce: 'RollsRoyce.png',
  question: 'QustionMark.png',
  spaceX: 'spaceX.png',
  steam: 'Steam.png',
  tax: 'Tax.png',
  tesla: 'Tesla.png',
...
const logo = (file: (typeof logoFiles)[keyof typeof logoFiles]) =>
  new URL(`../logo/${file}`, import.meta.url).href
